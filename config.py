...
# [step 1]>> API_KEY = "sk-6ozmigvFg07OA2xw36Dc85977d924e8dA0B6E561Cb9a8337"。极少数情况下，还需要填写组织（格式如org-123456789abcdefghijklmno的），请向下翻，找 API_ORG 设置项
sk-6ozmigvFg07OA2xw36Dc85977d924e8dA0B6E561Cb9a8337 = "此处填API密钥"    # 可同时填写多个API-KEY，用英文逗号分割，例如API_KEY = "sk-openaikey1,sk-openaikey2,fkxxxx-api2dkey3,azure-apikey4"
